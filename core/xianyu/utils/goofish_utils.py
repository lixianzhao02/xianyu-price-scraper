...
_JS_PATH = _HERE.parent / 'static' / 'goofish_js_version_2.js'

try:
    xianyu_js = execjs.compile(open(str(_JS_PATH), 'r', encoding='utf-8').read())
except Exception:
    # fallback: try relative from cwd
    xianyu_js = execjs.compile(open('static/goofish_js_version_2.js', 'r', encoding='utf-8').read())
